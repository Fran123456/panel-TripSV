        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              {!! Form::open(['route'=>'Guia.store','method'=> 'POST', 'id' => 'form'])!!}
            ...
            <div class="form-group">
               <div id="divdir"><label id="labeldir">Dirección:</label></div>
               {!! Form::text('direccion',null,['class'=>'form-control','placeholder'=>'Ingresa su direccion','onchange'=>'validar();']) !!}
            </div>
          ...
          <table class="table table-bordered table-hover table-striped" id="table">
               ...
               <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {!! Form::open(['route'=>['Guia.destroy', $item->id_guia],'method'=> 'DELETE'])  !!}
